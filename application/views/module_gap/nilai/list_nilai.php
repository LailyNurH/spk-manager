        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-header">
              <i class="fa fa-align-justify"></i>Tabel Data Nilai Alternatif
            </div>
            <div class="card-body">
              <nav>
                <form method="post">
                  <ul class="pagination">
                    <li class="page-item">
                      <a class="page-link"
                        href="<?php echo base_url('index.php/data_nilai1/index?tambah'); ?>">Tambah</a>
                    </li>&nbsp;&nbsp;
                    <li class="page-item">
                  ...
                  <ul class="pagination">
                    <li class="page-item">
                      <a class="page-link text-white bg-danger"
                        href="<?php echo base_url('index.php/data_nilai1/delete'); ?>"
                        onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Semua Data Nilai Alternatif ?')">Hapus
                        Semua Nilai</a>
                    </li>
                  </ul>
                </form>
                    ...
                    <tr>
                      ...
                      <td align="center">
                        <span class="badge badge-warning"><a
                            href="<?php echo base_url('index.php/data_nilai1/detail?id_alternatif=' . $row->id_alternatif); ?>">Detail</a></span>
                      </td>
                    </tr>
                  </tbody>
                  <?php
